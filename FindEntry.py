...
class FindEntry(Toplevel):
    def __init__(self, skeleton_key, entries):
        ...
        self.list_box = Listbox(self.bottom_frame, width=24, height=12,
        ...
        # close button
        self.close_button = ttk.Button(self.bottom_frame, text='Close', style='TButton', command=self.destroy)
